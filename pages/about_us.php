...
<head>
    ...
    <title>About Us - Construction Doctors</title>
...
<body>
    ...
    <section class="about-section">
        <div class="container">
            <h1 class="text-center">About Our Electrical Company</h1>
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="about-image">
                        <img src="../img/img2.jpg" alt="About Us Image" class="img-fluid">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="about-content">
                        <p>Welcome to Construction Doctors! We are a team of dedicated and experienced
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="team-member">
                        <img src="../img/img10.jpg" alt="Team Member 1">
                        <h3>Clinton Rusike</h3>
                        <p>Managing Director</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="team-member">
                        <img src="../img/img1.jpg" alt="Team Member 2">
                        <h3>Cynthia Chada</h3>
                        <p>Managing Director</p>
                    </div>
                </div>
    ...
    <section class="mission-section">
        <div class="container">
            ...
            <p class="text-center">At [Your Electrician Company Name], our mission is to provide reliable, safe, and
